...
//MediatR
//builder.Services.AddMediatR(typeof(CreateProjectCommands));
builder.Services.AddMediatR(x => x.RegisterServicesFromAssemblies(typeof(CreateProjectCommands).Assembly));
